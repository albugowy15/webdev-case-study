...
const Biodata = () => {
  return (
    ...
    >
      <div className="w-[300px] md:w-full lg:w-[600px] h-[300px] lg:h-[400px] relative border-8 border-gray-700 mx-auto">
        <Image
          src="/profil.jpg"
          layout="fill"
          objectFit="cover"
      ...
      <div className="p-4 flex flex-col items-start justify-start gap-4 md:gap-10">
        ...
        <button className="py-2 px-2 bg-orange-600 text-bold rounded-md">
          Download CV
        </button>
      </div>
    </div>
